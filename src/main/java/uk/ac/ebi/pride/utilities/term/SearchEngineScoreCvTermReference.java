...
public enum SearchEngineScoreCvTermReference {
    ...
    MS_BYONIC_BEST_LOGPROB(SearchEngineCvTermReference.MS_BYONIC, "MS", "MS:1002268", "Byonic:Best LogProb", null),
    MS_BYONIC_BEST_SCORE(SearchEngineCvTermReference.MS_BYONIC, "MS", "MS:1002269", "Byonic:Best Score", null),
    MS_BYONIC_DELTA_SCORE(SearchEngineCvTermReference.MS_BYONIC, "MS", "MS:1002263", "Byonic:Delta Score", null),
    MS_BYONIC_DELTAMOD_SCORE(SearchEngineCvTermReference.MS_BYONIC, "MS", "MS:1002264", "Byonic:DeltaMod Score", null),
    MS_BYONIC_PEP(SearchEngineCvTermReference.MS_BYONIC, "MS", "MS:1002265", "Byonic:PEP", null),
    ...
    MS_COMET_MATCHED_IONS(SearchEngineCvTermReference.MS_COMET, "MS", "MS:1002258", "Comet:matched ions", null),
    MS_COMET_SPRANK(SearchEngineCvTermReference.MS_COMET, "MS", "MS:1002256", "Comet:sprank", null),
    ...
    MS_MASCOT_MATCHED_IONS(SearchEngineCvTermReference.MS_MASCOT, "MS", "MS:1001173", "Mascot:matched ions", null),
    ...
    MS_MS_GF_PEP(SearchEngineCvTermReference.MS_MS_GF, "MS", "MS:1002056", "MS-GF:PEP", null),
    MS_MS_GF_PEPQVALUE(SearchEngineCvTermReference.MS_MS_GF, "MS", "MS:1002055", "MS-GF:PepQValue", null),
    ...
    MS_PARAGON_EXPRESSION_ERROR_FACTOR(SearchEngineCvTermReference.MS_ANALYSIS_SOFTWARE, "MS", "MS:1001168", "Paragon:expression error factor", null),
    ...
    MS_PHENYX_MODIF(SearchEngineCvTermReference.MS_PHENYX, "MS", "MS:1001398", "Phenyx:Modif", null),
    MS_PHENYX_NUMBEROFMC(SearchEngineCvTermReference.MS_PHENYX, "MS", "MS:1001397", "Phenyx:NumberOfMC", null),
    MS_PHENYX_PEPPVALUE(SearchEngineCvTermReference.MS_PHENYX, "MS", "MS:1001396", "Phenyx:PepPvalue", null),
    MS_PHENYX_PEPTIDES1(SearchEngineCvTermReference.MS_PHENYX, "MS", "MS:1001391", "Phenyx:Peptides1", null),
    MS_PHENYX_PEPTIDES2(SearchEngineCvTermReference.MS_PHENYX, "MS", "MS:1001392", "Phenyx:Peptides2", null),
    ...
    MS_PROTEINSCAPE_PROFOUNDPROBABILITY(SearchEngineCvTermReference.MS_PROTEINSCAPE, "MS", "MS:1001497", "ProteinScape:ProfoundProbability", null),
    ...
    MS_SEQUEST_EXPECTATION_VALUE(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001159", "SEQUEST:expectation value", null),
    MS_SEQUEST_MATCHED_IONS(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001161", "SEQUEST:matched ions", null),
    MS_SEQUEST_PEPTIDEIDNUMBER(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001219", "SEQUEST:PeptideIdnumber", null),
    MS_SEQUEST_PEPTIDENUMBER(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001218", "SEQUEST:PeptideNumber", null),
    MS_SEQUEST_PEPTIDERANKSP(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001217", "SEQUEST:PeptideRankSp", null),
    MS_SEQUEST_PEPTIDESP(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001215", "SEQUEST:PeptideSp", null),
    MS_SEQUEST_PROBABILITY(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001154", "SEQUEST:probability", null),
    MS_SEQUEST_SEQUENCES(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001372", "SEQUEST:Sequences", null),
    MS_SEQUEST_SF(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001160", "SEQUEST:sf", null),
    MS_SEQUEST_SP(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001157", "SEQUEST:sp", null),
    MS_SEQUEST_SPRANK(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1002249", "SEQUEST:sprank", null),
    MS_SEQUEST_SPSCORE(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1002248", "SEQUEST:spscore", null),
    MS_SEQUEST_SUM(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001374", "SEQUEST:Sum", null),
    MS_SEQUEST_TIC(SearchEngineCvTermReference.MS_SEQUEST, "MS", "MS:1001373", "SEQUEST:TIC", null),
    ...
    PRIDE_MASCOT_EXPECT_VALUE(SearchEngineCvTermReference.MS_MASCOT, "PRIDE", "PRIDE:0000212", "Mascot expect value", null),
    PRIDE_MASCOT_SCORE(SearchEngineCvTermReference.MS_MASCOT, "PRIDE", "PRIDE:0000069", "Mascot score", null),
    PRIDE_OMSSA_E_VALUE(SearchEngineCvTermReference.MS_OMSSA, "PRIDE", "PRIDE:0000185", "OMSSA E-value", null),
    PRIDE_OMSSA_P_VALUE(SearchEngineCvTermReference.MS_OMSSA, "PRIDE", "PRIDE:0000186", "OMSSA P-value", null),
    PRIDE_PEPSPLICE_DELSTASCORE(SearchEngineCvTermReference.PRIDE_PEPSPLICE, "PRIDE", "PRIDE:0000149", "PepSplice Deltascore", null),
    PRIDE_PEPSPLICE_FALSE_DISCOVERY_RATE(SearchEngineCvTermReference.PRIDE_PEPSPLICE, "PRIDE", "PRIDE:0000147", "PepSplice False Discovery Rate", null),
    PRIDE_PEPSPLICE_P_VALUE(SearchEngineCvTermReference.PRIDE_PEPSPLICE, "PRIDE", "PRIDE:0000148", "PepSplice P-value", null),
    PRIDE_PEPSPLICE_PENALTY(SearchEngineCvTermReference.PRIDE_PEPSPLICE, "PRIDE", "PRIDE:0000151", "PepSplice Penalty", null),
    PRIDE_PEPSPLICE_SCORE_COUNT(SearchEngineCvTermReference.PRIDE_PEPSPLICE, "PRIDE", "PRIDE:0000150", "PepSplice Score Count", null),
    PRIDE_PEPTIDE_PROPHET_DISCRIMINANT_SCORE(SearchEngineCvTermReference.PRIDE_PEPTIDE_PROPHET, "PRIDE", "PRIDE:0000138", "Discriminant score", null),
    PRIDE_PEPTIDE_PROPHET_PROBABILITY(SearchEngineCvTermReference.PRIDE_PEPTIDE_PROPHET, "PRIDE", "PRIDE:0000099", "PeptideProphet probability score", null),
    PRIDE_SEQUEST_CN(SearchEngineCvTermReference.MS_SEQUEST, "PRIDE", "PRIDE:0000052", "Cn", null),
    PRIDE_SEQUEST_DELTA_CN(SearchEngineCvTermReference.MS_SEQUEST, "PRIDE", "PRIDE:0000012", "Delta Cn", null),
    PRIDE_SEQUEST_SCORE(SearchEngineCvTermReference.MS_SEQUEST, "PRIDE", "PRIDE:0000053", "Sequest score", null),
    PRIDE_SPECTRUM_MILL_PEPTIDE_SCORE(SearchEngineCvTermReference.MS_SPECTRUM_MILL_FOR_MASSHUNTER_WORKSTATION, "PRIDE", "PRIDE:0000177", "Spectrum Mill peptide score", null),
